...
interface PermissionedStableDebtTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class PermissionedStableDebtToken extends Contract {
  ...
  interface: PermissionedStableDebtTokenInterface;
