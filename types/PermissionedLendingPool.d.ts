...
interface PermissionedLendingPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "PERMISSION_MANAGER()": FunctionFragment;
    ...
    "seize(address,address[],address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "PERMISSION_MANAGER",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class PermissionedLendingPool extends Contract {
  ...
  interface: PermissionedLendingPoolInterface;
  ...
  functions: {
    ...
    PERMISSION_MANAGER(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  PERMISSION_MANAGER(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    PERMISSION_MANAGER(overrides?: CallOverrides): Promise<BigNumber>;
