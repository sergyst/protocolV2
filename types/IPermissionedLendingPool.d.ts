...
interface IPermissionedLendingPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IPermissionedLendingPool extends Contract {
  ...
  interface: IPermissionedLendingPoolInterface;
