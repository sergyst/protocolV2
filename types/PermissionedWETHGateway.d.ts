...
interface PermissionedWETHGatewayInterface extends ethers.utils.Interface {
  functions: {
...
export class PermissionedWETHGateway extends Contract {
  ...
  interface: PermissionedWETHGatewayInterface;
