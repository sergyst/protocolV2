...
export const initReservesByHelper = async (
  ...
  console.log("===== initInputParams: "+JSON.stringify(initInputParams));
  console.log("===== reserveSymbols: "+JSON.stringify(reserveSymbols));
  ...
  console.log("================================================ >>>");
  console.log(`- configurator.batchInitReserve with chunkedInitInputParams: ${JSON.stringify(chunkedInitInputParams)}`);
  console.log(`- Reserves initialization in ${chunkedInitInputParams.length} txs`);
  for (let chunkIndex = 0; chunkIndex < chunkedInitInputParams.length; chunkIndex++) {
    console.log(`=== configurator.address ${configurator.address}`);
    console.log(`=== configurator.signer ${JSON.stringify(configurator.signer)}`);
    console.log(`=== configurator json ${JSON.stringify(configurator)}`);
    console.log(`=== await configurator.batchInitReserve. chunkedInitInputParam: ${chunkIndex}`);
    const tx = await configurator.batchInitReserve(chunkedInitInputParams[chunkIndex]);
    console.log(`=== waitForTx configurator.batchInitReserve. chunkedInitInputParam: ${chunkIndex}`);
