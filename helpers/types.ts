...
export type iCitiPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'TEST'
>;
...
export interface ICitiConfiguration extends ICommonConfiguration {
  ReservesConfig: iCitiPoolAssets<IReserveParams>;
}
