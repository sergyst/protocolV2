...
export const getPairsTokenAggregator = (
  ...
  console.log("===== allAssetsAddresses: "+JSON.stringify(allAssetsAddresses));
  console.log("===== aggregatorsAddresses: "+JSON.stringify(aggregatorsAddresses));
  console.log("===== oracleQuoteCurrency: "+oracleQuoteCurrency);
  console.log("===== quoteCurrencies: "+getQuoteCurrencies(oracleQuoteCurrency));
  const assetsWithoutQuoteCurrency = omit(
    allAssetsAddresses,
    getQuoteCurrencies(oracleQuoteCurrency)
  );

  console.log('===== assetsWithoutQuoteCurrency: '+JSON.stringify(assetsWithoutQuoteCurrency));
  console.log('===== assetsWithoutQuoteCurrency entries: '+Object.entries(assetsWithoutQuoteCurrency));
  const pairs = Object.entries(assetsWithoutQuoteCurrency).map(([tokenSymbol, tokenAddress]) => {
    //if (true/*tokenSymbol !== 'WETH' && tokenSymbol !== 'ETH' && tokenSymbol !== 'LpWETH'*/) {
    console.log('=============== ENTRY');
    console.log('===== tokenSymbol: '+tokenSymbol+", tokenAddress: "+tokenAddress);
    const aggregatorAddressIndex = Object.keys(aggregatorsAddresses).findIndex(
      (value) => value === tokenSymbol
    );
    console.log('===== aggregatorAddressIndex: '+aggregatorAddressIndex);
    console.log('===== aggregatorsAddresses entries: '+Object.entries(aggregatorsAddresses));
    const [, aggregatorAddress] = (
      Object.entries(aggregatorsAddresses) as [string, tEthereumAddress][]
    )[aggregatorAddressIndex];
    console.log('=============== RETURN tokenAddress: '+tokenAddress+", aggregatorAddress: "+aggregatorAddress);
...
===== quoteCurrencies: ETH,WETH
===== assetsWithoutQuoteCurrency: [object Object]
===== assetsWithoutQuoteCurrency entries: TEST,0xC702932fC75645322c682Bd6B4d58c538cAdCd7b,USD,0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96
=============== ENTRY
===== tokenSymbol: TEST, tokenAddress: 0xC702932fC75645322c682Bd6B4d58c538cAdCd7b
===== aggregatorAddressIndex: 0
===== aggregatorsAddresses entries: TEST,0x2Deaba9107bf5bce28cb66F6106Dd544bc4CaE1f
=============== RETURN tokenAddress: 0xC702932fC75645322c682Bd6B4d58c538cAdCd7b, aggregatorAddress: 0x2Deaba9107bf5bce28cb66F6106Dd544bc4CaE1f
=============== ENTRY
===== tokenSymbol: USD, tokenAddress: 0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96
===== aggregatorAddressIndex: -1
===== aggregatorsAddresses entries: TEST,0x2Deaba9107bf5bce28cb66F6106Dd544bc4CaE1f
An unexpected error occurred:

TypeError: undefined is not iterable (cannot read property Symbol(Symbol.iterator))
    at /Users/sergeysteblin/dev/aave/protocol-v2-feat-permissioned-market-citi/helpers/contracts-getters.ts:231:7
    at Array.map (<anonymous>)
    at Object.getPairsTokenAggregator (/Users/sergeysteblin/dev/aave/protocol-v2-feat-permissioned-market-citi/helpers/contracts-getters.ts:221:60)
*/
