...
export const getParamPerNetwork = <T>(param: iParamsPerNetwork<T>, network: eNetwork) => {
  const { main, citi, ropsten, kovan, coverage, buidlerevm, tenderly } =
...
export const getParamPerPool = <T>({ proto, amm, matic, arc, citi, avalanche }: iParamsPerPool<T>, pool: AavePools) => {
  switch (pool) {
