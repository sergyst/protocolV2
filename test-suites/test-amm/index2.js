...
const initializeContracts = async () => {
  try {
    tokenTESTContract = new web3.eth.Contract(
      tokenTESTABI.abi,
      tokenTESTAddress
    );
    lendingPoolAddressesProvider = new web3.eth.Contract(
      lendingPoolAddressesProviderABI.abi,
...
const unpause = async () => {
  ...
  let lendingPoolConfigurator = new web3.eth.Contract(
  ...
  console.log(
    "emergencyAdmin",
    await lendingPoolAddressesProvider.methods.getEmergencyAdmin().call()
  );
  console.log("\n");
